...
function PortugueseStemmer() {
	var a_0 = [new Among("", -1, 3), new Among("\u00E3", 0, 1),
			...
			new Among("ã", 0, 1), new Among("õ", 0, 2)], a_2 = [
			...
			new Among("ivo", -1, 8), new Among("a\u00E7ão", -1, 1),
			...
			new Among("issem", 29, 1), new Among("inha", 29, 1),
            new Among("ado", -1, 1), new Among("haha", -1, 1),
            new Among("hahaha", -1, 1),
            new Among("hahahaha", -1, 1),
			new Among("ido", -1, 1), new Among("ando", -1, 1),
			new Among("endo", -1, 1), new Among("indo", -1, 1),
			new Among("arão", -1, 1), new Among("arao", -1, 1),
            new Among("erão", -1, 1), new Among("erao", -1, 1),
			new Among("irão", -1, 1), new Among("irao", -1, 1),
            new Among("ar", -1, 1),
